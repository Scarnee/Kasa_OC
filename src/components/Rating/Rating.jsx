...
// Creating function to create stars with svg format with color as props
function Star(color) {
    return (
        <svg width="25" height="24" viewBox="0 0 25 24" fill={color.fill} xmlns="http://www.w3.org/2000/svg">
...
function Rating({ rating }) {
    return (
        <div className="ratings">
            {/*Calling Star function 5 times and changing fill color depending on rating */}
            <Star fill={rating >= 1 ? "#ff6060" : "#e6e6e6"} />
            <Star fill={rating >= 2 ? "#ff6060" : "#e6e6e6"} />
            <Star fill={rating >= 3 ? "#ff6060" : "#e6e6e6"} />
            <Star fill={rating >= 4 ? "#ff6060" : "#e6e6e6"} />
            <Star fill={rating >= 5 ? "#ff6060" : "#e6e6e6"} />
        </div>
    );
}
